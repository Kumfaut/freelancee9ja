...
import { 
  ...
  Clock, Info, CheckCircle, Share2, Globe
} from "lucide-react";
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Textarea 
                ...
                className="min-h-[160px] mt-1 rounded-2xl border-slate-200 font-medium leading-relaxed p-4" 
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2 space-y-10">
            ...
            <Card className="border-none shadow-sm rounded-[2.5rem] p-10 bg-white ring-1 ring-slate-100">
                ...
                <p className="text-slate-600 leading-[1.8] text-lg whitespace-pre-wrap font-medium">{job?.description}</p>
          ...
          <aside className="space-y-8">
            <Card className="border-none shadow-2xl bg-slate-900 text-white rounded-[3rem] p-10 relative overflow-hidden group">
                ...
                <div className="relative z-10">
                    ...
                    {job?.hasApplied ? (
                        <div className="w-full h-20 bg-slate-800 text-emerald-400 font-black rounded-[1.5rem] border border-slate-700 flex items-center justify-center gap-3 uppercase tracking-widest text-xs">
                            <CheckCircle size={22} />
                            {t('application_sent')}
                        </div>
                    ) : (
                        <Button 
                            ...
                            className="w-full h-20 bg-emerald-500 hover:bg-white hover:text-slate-900 text-slate-900 font-black rounded-[1.5rem] transition-all text-sm uppercase tracking-[0.2em] shadow-2xl shadow-emerald-500/30 active:scale-95"
                        >
                            {t('apply_now')}
                        </Button>
                    )}
                    
                    <p className="mt-8 text-[9px] text-slate-500 font-black uppercase tracking-widest text-center italic">
                        {job?.hasApplied ? t('already_applied') : t('hiring_active')}
                    </p>
                </div>
            </Card>
